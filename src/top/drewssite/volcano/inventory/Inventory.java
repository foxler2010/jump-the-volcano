...
public class Inventory {
     ...
     * @see Inventory
     */
    public Inventory(int maxTotalItems, ArrayList<Item> maxItemsID, ArrayList<Integer> maxItemsAmount, ArrayList<ItemType> maxItemsOfTypeID, ArrayList<Integer> maxItemsOfTypeAmount) {
